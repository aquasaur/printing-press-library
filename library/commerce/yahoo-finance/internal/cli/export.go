...
large datasets as it has no memory pressure.`,
  ...
  yahoo-finance-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  yahoo-finance-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  yahoo-finance-pp-cli export <resource> --format jsonl | jq '.id'`,
