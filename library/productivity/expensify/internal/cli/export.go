...
large datasets as it has no memory pressure.`,
  ...
  expensify-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  expensify-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  expensify-pp-cli export <resource> --format jsonl | jq '.id'`,
