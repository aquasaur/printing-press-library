...
but do not stop the import.`,
  ...
  nsw-transport-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  nsw-transport-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | nsw-transport-pp-cli import <resource> --input -`,
