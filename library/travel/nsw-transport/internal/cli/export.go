...
large datasets as it has no memory pressure.`,
  ...
  nsw-transport-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  nsw-transport-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  nsw-transport-pp-cli export <resource> --format jsonl | jq '.id'`,
