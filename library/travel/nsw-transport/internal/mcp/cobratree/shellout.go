...
// blockedRootFlags are global flags an MCP client must not be able to set via
// the structured args map: they redirect where the CLI reads credentials,
// where output goes, or apply a saved flag set — control-plane surface, not
