...
but do not stop the import.`,
  ...
  bing-webmaster-tools-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  bing-webmaster-tools-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | bing-webmaster-tools-pp-cli import <resource> --input -`,
