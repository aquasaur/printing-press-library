...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  bing-webmaster-tools-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  bing-webmaster-tools-pp-cli workflow archive --full`,
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  bing-webmaster-tools-pp-cli workflow status

  # Show status as JSON
  bing-webmaster-tools-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("bing-webmaster-tools-pp-cli")
			}
