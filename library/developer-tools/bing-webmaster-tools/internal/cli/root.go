...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "bing-webmaster-tools-pp-cli",
		Short: `Every Bing Webmaster Tools API method, plus a local SQLite store, offline search, and SEO analytics no other Bing tool has — built agent-native.`,
		Long: `Every Bing Webmaster Tools API method, plus a local SQLite store, offline search, and SEO analytics no other Bing tool has — built agent-native.
...
Health check: run 'bing-webmaster-tools-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("bing-webmaster-tools-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'bing-webmaster-tools-pp-cli profile list')")
	...
	rootCmd.AddCommand(newBlockUrlsCmd(flags))
	...
	rootCmd.AddCommand(newPagePreviewCmd(flags))
	rootCmd.AddCommand(newQueryParamsCmd(flags))
	...
	attachNovelCommands(rootCmd, flags)
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("bing-webmaster-tools-pp-cli %s\n", version)
		},
	}
}
